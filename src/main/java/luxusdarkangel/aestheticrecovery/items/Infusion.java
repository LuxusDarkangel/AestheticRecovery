...
public class Infusion extends ItemRecord
{	
    public Infusion(int id, String recordName)
    {
        super(id, recordName);
        this.maxStackSize = 1;
    ...
    {
        return "LuxusDarkangel - Angelical Infusion";
    }
    ...
    {
    	this.itemIcon = reg.registerIcon(AestheticRecovery.modid + ":infusion");
    }
}