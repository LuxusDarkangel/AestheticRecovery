...
public class Aurora extends ItemRecord
{	
    public Aurora(int id, String recordName)
    {
        super(id, recordName);
        this.maxStackSize = 1;
    ...
    {
    	this.itemIcon = reg.registerIcon(AestheticRecovery.modid + ":aurora");
    }
}