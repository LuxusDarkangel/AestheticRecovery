...
public class Luxus extends ItemRecord
{	
    public Luxus(int id, String recordName)
    {
        super(id, recordName);
        this.maxStackSize = 1;
    ...
    {
        return "LuxusDarkangel - Luxus Theme";
    }
    ...
    {
    	this.itemIcon = reg.registerIcon(AestheticRecovery.modid + ":luxus");
    }
}