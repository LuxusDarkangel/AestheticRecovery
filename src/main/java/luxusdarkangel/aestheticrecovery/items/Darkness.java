...
public class Darkness extends ItemRecord
{	
    public Darkness(int id, String recordName)
    {
        super(id, recordName);
        this.maxStackSize = 1;
    ...
    {
        return "LuxusDarkangel - Darkness";
    }
    ...
    {
    	this.itemIcon = reg.registerIcon(AestheticRecovery.modid + ":darkness");
    }
}