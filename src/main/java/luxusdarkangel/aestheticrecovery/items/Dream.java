...
public class Dream extends ItemRecord
{	
    public Dream(int id, String recordName)
    {
        super(id, recordName);
        this.maxStackSize = 1;
    ...
    {
        return "LuxusDarkangel - Around my Dreams";
    }
    ...
    {
    	this.itemIcon = reg.registerIcon(AestheticRecovery.modid + ":dream");
    }
}