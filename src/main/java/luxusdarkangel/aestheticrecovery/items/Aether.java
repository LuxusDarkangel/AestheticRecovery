...
public class Aether extends ItemRecord
{	
    public Aether(int id, String recordName)
    {
        super(id, recordName);
        this.maxStackSize = 1;
    ...
    {
    	this.itemIcon = reg.registerIcon(AestheticRecovery.modid + ":aether");
    }
}