...
public class Slave extends ItemRecord
{	
    public Slave(int id, String recordName)
    {
        super(id, recordName);
        this.maxStackSize = 1;
    ...
    {
        return "LuxusDarkangel - Just an Slave";
    }
    ...
    {
    	this.itemIcon = reg.registerIcon(AestheticRecovery.modid + ":slave");
    }
}